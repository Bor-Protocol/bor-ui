export const NEW_STREAM_CONFIGS = {
  ...
  sceneConfigs: [{
    ...
    models: [{
      ...
      modelPosition: [1.51, -0.4999999999999999, -7.650000000000005],
      modelRotation: [0, 7.799999999999988, 0],
      modelScale: [0.9605960100000004, 0.9605960100000004, 0.9605960100000004]
    }],
    environmentScale: [1, 1, 1],
    environmentPosition: [3, -1, -3.5],
    environmentRotation: [0, 1.5707963267948966, 0],
    cameraPitch: 0,
    cameraPosition: [2.86339364354024, 0.75999999999999, -7.734076601144114],
